...
void MainWindow::on_ShuffleButton_clicked()
{
    ...
    if (!selectedFiles.isEmpty()) {
        ...
        auto rngSeed = static_cast<std::mt19937::result_type>(QRandomGenerator::global()->generate());
        std::mt19937 generator(rngSeed);
        std::shuffle(selectedFiles.begin() + currentSongIndex + 1, selectedFiles.end(), generator);
